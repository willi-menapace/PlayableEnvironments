...
class DynamicsNetworkV9(nn.Module):
    '''
    Model for the dynamics of the environment. Like V4 but with normalization of translations
    '''
    ...
    def __init__(self, config: Dict, model_config: Dict):
        ...
        '''
        super(DynamicsNetworkV9, self).__init__()
    ...
    def forward(self, current_object_rotations: torch.Tensor, current_object_translations: torch.Tensor,
        ...
        current_normalized_object_translations = current_object_translations / bounding_box_size
        current_cell_input = torch.cat([current_encoded_rotations, current_normalized_object_translations, current_object_style, current_object_deformation,
...
def model(config, model_config):
    ...
    :return:
    '''
    return DynamicsNetworkV9(config, model_config)
