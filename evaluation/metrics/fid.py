...
class FID(nn.Module):
    ...
    def calculate_activation_statistics(dataloader, model):
        ...
        -- sigma : The covariance matrix of the activations of the pool_3 layer of
                   the inception model.
        """
        act = FID.get_activations(dataloader, model)
    ...
    def __call__(self, reference_dataloader, generated_dataloader) -> float:
        ...
        m1, s1 = FID.calculate_activation_statistics(reference_dataloader, model)
        m2, s2 = FID.calculate_activation_statistics(generated_dataloader, model)
