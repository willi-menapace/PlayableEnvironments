...
if __name__ == "__main__":
    ...
    reference_dataset_splits = DatasetSplitter.generate_evaluate_reconstructed_camera_manipulation_dataset_splits(config, "reference")
    generated_dataset_splits = DatasetSplitter.generate_evaluate_reconstructed_camera_manipulation_dataset_splits(config, "generated")
    ...
    output_path = os.path.join(config["logging"]["output_directory"], "reconstructed_camera_manipulation_dataset_evaluation.yaml")
